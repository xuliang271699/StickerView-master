...
import com.example.abner.stickerdemo.view.StickerTextView;
...
public class MainTextActivity extends AppCompatActivity {
    ...
    private void addStickerView() {
        final StickerTextView stickerView = new StickerTextView(this);

        if(mStickers.size()%2==1){
//            stickerView.setImageResource(R.mipmap.ic_cat);
            stickerView.setText("测试下1");
        }else
            stickerView.setText("测试2");
...
//        stickerView.set
        ...
        stickerView.setOperationListener(new StickerTextView.OperationListener() {
            @Override
            ...
            @Override
            public void onEdit(StickerTextView stickerView) {
...
//
//                //在老位置重新添加
//                mContentRootView.addView(stickerView);
            ...
            @Override
            public void onTop(StickerTextView stickerView) {
